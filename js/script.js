...
fetch('https://quiztai.herokuapp.com/api/quiz')
    ...
    function clearAnswers(){
        if(currentElemenent !== null){
            currentElemenent.classList.remove('correct');
            currentElemenent.classList.remove('incorrect');
        }
    }
